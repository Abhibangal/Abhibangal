...
*   **Microsoft Fabric:** Unifying enterprise data workloads using OneLake, Data Factory, and Synapse Analytics.
*   **Strategic Advisory:** Aligning technical data solutions with enterprise business objectives and governance standards.

### 🛠️ Tech Stack & Tools
*   **Core Platforms:** Snowflake, Microsoft Fabric, Azure Databricks
